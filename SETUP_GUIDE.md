...
| **`dafservice`** | ✅ Yes | ✅ Yes | ❌ No | DAF services for data processing and analytics | `POST /apis/v1/rest/projects/{projectName}/flows/{assetID}/export`<br>`POST /apis/v1/rest/projects/{projectName}/flow-import` |
